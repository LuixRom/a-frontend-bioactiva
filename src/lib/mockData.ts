...
export const mockLeads: Lead[] = [
  {
    ...
    proximaActividad: 'Presentación de servicios ante Sub-Gerencia. Solicitan cotización detallada.',
    fechaProximaActividad: new Date('2025-03-10'),
  ...
  },
  {
    ...
    estado: 'en_proceso',
    proximaActividad: 'Revisión de sustento técnico y preparación de expediente I+D.',
    fechaProximaActividad: new Date('2026-03-15'),
    actividades: [
      {
        id: 'ACT-006',
        tipo: 'reunion',
        ...
        fechaCompletada: new Date('2025-04-10'),
      },
      {
        id: 'ACT-020',
        tipo: 'email',
        estado: 'pendiente',
        nota: 'Revisión de sustento técnico y preparación de expediente I+D.',
        responsable: 'Luis Torres',
